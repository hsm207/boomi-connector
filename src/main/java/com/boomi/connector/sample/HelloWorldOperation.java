...
/**
 * Hello World! {@link Operation} implementation which extends {@link BaseUpdateOperation} for convenience.
 */
public class HelloWorldOperation extends BaseUpdateOperation {
    ...
    /**
     * Adds a combined success with the name specified in the operation as a payload. NOTE: String payloads should
